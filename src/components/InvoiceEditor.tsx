...
export function InvoiceEditor({ invoice, initialCustomerId, onClose, onCreateCustomer, onNavigateToCustomers, onNavigateToSettings }: InvoiceEditorProps) {
  ...
  useEffect(() => {
    ...
    if (invoice) {
      ...
      nextFormData = { ...initialNewInvoiceFormData.current, invoiceNumber: '', customerId: initialCustomerId || '' };
      nextItems = [];
      nextAttachments = [];
      setFormData(nextFormData);
      setItems(nextItems);
